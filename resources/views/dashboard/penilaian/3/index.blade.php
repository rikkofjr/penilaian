                    ...
                    <div class="tab-pane fade show active" id="t1" role="tabpanel">
                        ...
                        <table class="table table-striped">
                            ...
                            <tr>
                                ...
                                <td><a href="{{route('beriPenilaian3', ['id_pelatihan' => $pstx->id_pelatihan, 'nip' => $pstx->nip])}}">{{$pstx->nip}}</a></td>
                    ...
                    <div class="tab-pane fade" id="t2" role="tabpanel">
                        ...
                        <table class="table table-stripped">
                            ...
                            <tr>
                                ...
                                <td>{{$pst->total_n4}}</td>
                                <td>{{$pst->total_n5}}</td>
                                <td>{{$pst->total_n1 + $pst->total_n2 + $pst->total_n3 + $pst->total_n4 + $pst->total_n5 }}
                                </td>
                            </tr>
                            @endforeach
                        </table>
